# Site2Local
**Vibe-coded** python 3 tool which makes a existent website running on localhost known as 127.0.0.1!

# What i can change on it?
You can change if you want or dont want to use the dump frenesis, you can enable or disable crawling (if you have already crawled the site), and change headers to mobile, tablet, desktop, macintosh, ie11, iphone, ipad, symbian, and bot, optional thing is that also you can enable rainbow logs (inspired by lolcat)
